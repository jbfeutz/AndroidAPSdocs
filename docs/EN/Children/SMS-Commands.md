...
- Note that the "+" in front of the number may or may not be required depending on your location. You can determine this by sending a sample text which will display the received format in the SMS communicator tab.
